...
const processosSaoPaulo: Array<Omit<Processo, "prefeituraId">> = [
  {
    ...
    trilha: [
      t("geracao_documento", "rascunho", "em_elaboracao", "Maria Costa", "servidor_compras", "2024-07-05",
  ...
  },
  {
    ...
    urgente: true,
    trilha: [
      t("geracao_documento", "rascunho", "em_elaboracao", "João Silva", "servidor_compras", "2024-07-03",
        "ETP, TR e Edital concluídos; encaminho para análise da comissão."),
      t("geracao_documento", "em_elaboracao", "em_elaboracao", "Comissão de Contratação", "comissao", "2024-07-04",
  ...
  },
  {
    ...
    fases: { verificacaoDFD: false, retificacao: false },
    trilha: [
      t("geracao_documento", "rascunho", "em_elaboracao", "Ana Oliveira", "servidor_compras", "2024-07-03",
        "Instrução completa com Cotação, ETP, TR, Edital e minuta de Contrato."),
      t("geracao_documento", "em_elaboracao", "em_elaboracao", "Comissão de Contratação", "comissao", "2024-07-04",
        "Conformidade verificada. Encaminhado para aprovação."),
      t("encerramento", "em_elaboracao", "concluido", "Carlos Lima", "gestor_aprovador", "2024-07-04",
  ...
  },
  {
    ...
    fases: { verificacaoDFD: false, retificacao: false },
    trilha: [
      t("geracao_documento", "rascunho", "em_elaboracao", "Maria Costa", "servidor_compras", "2024-07-01",
        "Documentos concluídos; enviado para análise."),
      t("geracao_documento", "em_elaboracao", "em_elaboracao", "Comissão de Contratação", "comissao", "2024-07-01",
        "Documentação conferida. Segue para decisão do gestor."),
      t("encerramento", "em_elaboracao", "concluido", "Carlos Lima", "gestor_aprovador", "2024-07-02",
        "Processo aprovado."),
      t("encerramento", "em_elaboracao", "concluido", "Carlos Lima", "gestor_aprovador", "2024-07-02",
  ...
  },
  {
    ...
    urgente: true,
    trilha: [
      t("geracao_documento", "rascunho", "em_elaboracao", "Pedro Ramos", "servidor_compras", "2024-07-01",
        "Processo instruído para análise jurídica."),
      t("retificacao", "em_elaboracao", "em_elaboracao", "Carlos Lima", "gestor_aprovador", "2024-07-02",
        "Solicito retificação: incluir comparativo de preços exigido pelo Art. 23, Lei 14.133/21."),
      t("geracao_documento", "em_elaboracao", "em_elaboracao", "Pedro Ramos", "servidor_compras", "2024-07-03",
  ...
  },
  {
    ...
    fases: { verificacaoDFD: false, retificacao: false },
    trilha: [
      t("geracao_documento", "rascunho", "em_elaboracao", "Ana Oliveira", "secretaria_demandante", "2024-06-30",
  ...
  },
  {
    ...
    fases: { verificacaoDFD: false, retificacao: false },
    trilha: [
      t("geracao_documento", "rascunho", "em_elaboracao", "João Silva", "servidor_compras", "2024-06-27",
        "Documentos concluídos; enviado para análise."),
      t("geracao_documento", "em_elaboracao", "em_elaboracao", "Comissão de Contratação", "comissao", "2024-06-27",
        "Encaminhado para decisão do gestor."),
      t("reabertura", "concluido", "em_elaboracao", "Carlos Lima", "gestor_aprovador", "2024-06-28",
...
const processosEcoporanga: Array<Omit<Processo, "prefeituraId">> = [
  {
    ...
    trilha: [
      t("geracao_documento", "rascunho", "em_elaboracao", "Beatriz Amaral", "servidor_compras", "2024-07-10",
        "Documentos concluídos; enviado para análise."),
    ],
  },
  {
